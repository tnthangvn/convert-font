 ...
 * If the name already starts with `rvi-`, return it unchanged.
 *
 * @param {string} name
 ...
 *
 * @param {string} baseName   — the candidate name (e.g. `rvi-user`)
 ...
 * @param {Set<string>|Array<string>} existingNames — names already in the font
 * @param {object} [opts]
 * @param {string} [opts.prefix='rvi']
 * @param {boolean} [opts.allowDuplicate=true] — if true, auto-suffix; if false, return base name as-is
 * @returns {string}
 */
